...
Para comparar com o Atlas genérico, clique no mesmo marco anatômico no Atlas e no corte 2D, pressione **Adicionar par** e repita em pelo menos três pontos não colineares e bem distribuídos. **Ajustar** calcula escala uniforme, rotação e translação e mostra a sobreposição no visor espacial. Depois do ajuste, o painel **Sobreposição neurovascular 3D** permite combinar encéfalo/nervos, artérias/vasos e esqueleto. A visualização pode mostrar o volume completo ou uma lâmina axial, coronal ou sagital de uma célula, cuja posição acompanha a mira compartilhada e o scroll das reconstruções MPR.

A distância RMS informa apenas o desvio nos marcos escolhidos, não a precisão nas outras estruturas. A sobreposição continua sendo um Atlas genérico registrado manualmente; ela não é segmentação da anatomia individual nem garante correspondência exata longe dos marcos. Os pares e o ajuste são descartados ao trocar de série ou de modelo. A superfície CT e as fatias compartilham LPS em milímetros; o Atlas exige esse ajuste adicional.
